...
=======
          ...
          <li v-if="optionValue == '主观题'">
            <span>难度等级:</span>
            <el-select v-model="postSubject.level" placeholder="选择难度等级" class="w150">
              <el-option
                v-for="item in levels"
                :key="item.value"
                :label="item.label"
...
=======
        <!-- 主观题部分 -->
        <div class="change fill" v-if="optionValue == '主观题'">
          <div class="title">
            <el-tag>题目:</el-tag><span>输入题目,形如--打印输出Hello World</span>
            <el-input
              type="textarea"
              rows="4"
          ...
          <div class="fillAnswer">
            <el-tag>正确答案:</el-tag>
            <el-input v-model="postSubject.answer"></el-input>
          </div>
          <div class="title analysis">
            <el-tag type="success">解析:</el-tag><span>下方输入框中输入答案解析</span>
            <el-input
          ...
          <div class="submit">
            <el-button type="primary" @click="subjectSubmit()">立即添加</el-button>
          </div>
        </div>
>>>>>>> e0009d7 (增加主观题类型)
      </section>
...
<<<<<<< HEAD
=======
            <span>主观题数量：</span> <el-input type="text" v-model="subjectNumber"></el-input>
          </li>
          <li>
>>>>>>> e0009d7 (增加主观题类型)
...
=======
    ...
    subjectSubmit() { //主观题提交
      ...
      this.$axios({
        ...
        this.$axios(`/api/subjectQuestionId`).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
